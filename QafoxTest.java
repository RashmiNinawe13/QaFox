...
public class QafoxTest extends BaseTest {
    ...
    public void testRegister() {
        ...
        driver.findElement(By.id("input-lastname")).sendKeys("Ninawe");
        ...
        driver.findElement(By.id("input-password")).sendKeys("Rashmi@25");
        driver.findElement(By.id("input-confirm")).sendKeys("Rashmi@25");
